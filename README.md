...
The audience of this README is the **client developer**, i.e. someone who will **use** `claim-processor`.

If you are an **API developer** who will make changes to `claim-processor` itself, please see [`src/claim-processor/README.md`](./src/claim-processor/README.md).
...
`claim-processor` provides URL templates for all collections by way of its `item` rel [[RFC6573](https://datatracker.ietf.org/doc/html/rfc6573)].
```json
{
    "_items": [
      ...
...
Here are the link relations provided by `claim-processor`
...
* `claim-processor` follows a field naming convention so you know when such a field is "embeddable"
